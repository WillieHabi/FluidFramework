...
The schemas are compiled in isolation (tsconfig.crossPackage.json) and consumed
through the package export map.

When tree's export tiers share the same JS module, the .d.ts import paths get
normalized from import("@fluidframework/tree/alpha") to import("@fluidframework/tree"),
